<?php
////////////////////////////////////////////////////////////////
// 24 HOUR TEMPERATURE AND HUMIDITY LOGGING LINE CHART
// Andrew Taylor 2016 
//
...
$timestamp = strtotime('now') - 24*60*60;
/* Format timestamp for DB */
$Yesterday = date("Y-m-d H:i:s",$timestamp);
/* DB results */
...
$statement->bindValue(':id',$Yesterday);
/* Results array */
...
/* Heading Time Frame */
$myPicture->drawText(540,35,"24 HOURS",array("FontSize"=>20,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
/* Heading Temperature */
